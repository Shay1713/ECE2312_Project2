...
%graph1 = graphing('Spectogram team[8]-sinetone.wav', 'Time (seconds)', 'Frequency (Hz)', filename1,hamming(512), 256, 1024, 44100);
...
%graph2 = graphing('Spectogram team[8]-chirp.wav', 'Time (seconds)', 'Frequency (Hz)', filename2,hamming(512), 256, 1024, 44100);
...
%graph3 = graphing('Spectogram team[8]-cetk.wav', 'Time (seconds)', 'Frequency (Hz)', filename3,hamming(512), 256, 1024, 44100);
...
%graph4 = graphing('Spectogram team[8]-speechchirp.wav', 'Time (seconds)', 'Frequency (Hz)', filename4,hamming(512), 256, 1024, 44100);
...
%graph5 = graphing('Spectogram team[8]-speechchirp2.wav', 'Time (seconds)', 'Frequency (Hz)', filename5,hamming(512), 256, 1024, 44100);
...
%graph6 = graphing('Spectogram team[8]-filteredspeechsine.wav', 'Time (seconds)', 'Frequency (Hz)', filename6,hamming(512), 256, 1024, 44100);
...
%graph7 = graphing('Spectogram team[8]-filteredspeechsine2.wav', 'Time (seconds)', 'Frequency (Hz)', filename7,hamming(512), 256, 1024, 44100);
...
%graph8 = graphing('Spectogram team[8]-stereospeechsine.wav', 'Time (seconds)', 'Frequency (Hz)', filename8,hamming(512), 256, 1024, 44100);
...
%graph9 = graphing('Spectogram team[8]-stereospeechsine2.wav', 'Time (seconds)', 'Frequency (Hz)', filename9,hamming(512), 256, 1024, 44100);
